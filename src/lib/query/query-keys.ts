...
export const queryKeys = {
  ...
  accounting: {
    ...
    invoiceRegistration: (incomeStatementId: number, invoiceNumber: string) =>
      [...queryKeys.accounting.all, "invoice-registration", incomeStatementId, invoiceNumber] as const,
