      ...
      {state.query.isLoading ? <p className="p-6">{t("common.loading")}</p> : state.query.isError ?
        ...
        <table className="w-full text-sm">
          <thead className="border-b bg-muted/40 text-left"><tr>
            <th className="px-4 py-3">ID</th><th className="px-4 py-3">{t("employeeTitles.name")}</th><th className="px-4 py-3">{t("employeeTitles.active")}</th><th className="px-4 py-3 text-right">{t("common.actions.actions")}</th>
          </tr></thead>
