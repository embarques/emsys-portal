...
export default function Page() {
  return <div>
    <PageHeader title="Orders" description="Sample Orders page inside the same responsive dashboard shell." actions={<Button><Plus className="h-4 w-4" /> Add new</Button>} />
