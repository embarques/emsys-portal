...
export default function Page() {
  return <div>
    <PageHeader title="Security" description="Sample Security page inside the same responsive dashboard shell." actions={<Button><Plus className="h-4 w-4" /> Add new</Button>} />
